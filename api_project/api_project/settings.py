...
SECRET_KEY = 'django-insecure-dccl0n_v&g1=$^c_oh$#1-s^yh=a9y5vp=fay%m1od!y9b#z86'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication',  # Optional: For the browsable API
    ],
}